...
local Button = Player:CreateButton({
 ...
 local Section = Player:CreateSection("Modifiers")
...
local Toggle = Player:CreateToggle({
 ...
 local Paragraph = Player:CreateParagraph({Title = "Lock Multiplier Values Toggle", Content = "When its turned on, it will prevent your walkspeed/jumppower to be changed automaticly by the game once you reset your character or die so you won't have to manually adjust the changes everytime after you reset/die."})
